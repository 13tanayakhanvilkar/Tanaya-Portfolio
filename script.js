...
// ========================
// PROJECT CASE-STUDY CTAS
// ========================
const renderCaseStudyButton = caseStudyLink => {
  const button = document.createElement('span');
  button.className = 'case-study-button';
  button.textContent = 'View Case Study';
  button.dataset.caseStudyLink = caseStudyLink;
  return button;
};

document.querySelectorAll('.projects-grid > .project-card[href]').forEach(projectCard => {
  const caseStudyLink = projectCard.getAttribute('href');
  if (!caseStudyLink || projectCard.querySelector('.case-study-button')) return;
  projectCard.append(renderCaseStudyButton(caseStudyLink));
});
